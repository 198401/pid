...
void spHandle(void)
{
    ...
    {
    case 1:
        if (g_UnitCfg.dat.iSpMa0 != g_UnitCfg.dat.iSpMa20)
            g_UnitData.dat.fSp    = 10.0f*g_UnitCfg.dat.bySpD 
                                    + 10.0f*(g_UnitCfg.dat.bySpU - g_UnitCfg.dat.bySpD)*(temp - g_UnitCfg.dat.iSpMa0)/(g_UnitCfg.dat.iSpMa20 - g_UnitCfg.dat.iSpMa0);
        break;
    case 2:
        if (g_UnitCfg.dat.iSpV0 != g_UnitCfg.dat.iSpV5)
            g_UnitData.dat.fSp   = 10.0f*g_UnitCfg.dat.bySpD 
                                   + 10.0f*(g_UnitCfg.dat.bySpU - g_UnitCfg.dat.bySpD)*(temp - g_UnitCfg.dat.iSpV0)/(g_UnitCfg.dat.iSpV5 - g_UnitCfg.dat.iSpV0);
        break;
    case 3:
        if (g_UnitCfg.dat.iSpV0 != g_UnitCfg.dat.iSpV10)
            g_UnitData.dat.fSp   = 10.0f*g_UnitCfg.dat.bySpD 
                                   + 10.0f*(g_UnitCfg.dat.bySpU - g_UnitCfg.dat.bySpD)*(temp - g_UnitCfg.dat.iSpV0)/(g_UnitCfg.dat.iSpV10 - g_UnitCfg.dat.iSpV0);
        break;
    default:
        if (g_UnitCfg.dat.iSpMa4 != g_UnitCfg.dat.iSpMa20)
            g_UnitData.dat.fSp    = 10.0f*g_UnitCfg.dat.bySpD 
                                    + 10.0f*(g_UnitCfg.dat.bySpU - g_UnitCfg.dat.bySpD)*(temp - g_UnitCfg.dat.iSpMa4)/(g_UnitCfg.dat.iSpMa20 - g_UnitCfg.dat.iSpMa4);
        break;
    } 
}
